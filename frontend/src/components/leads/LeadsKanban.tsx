...
const LEAD_STATUSES = [
  ...
  { value: "HOT", label: "Hot", color: "bg-red-100 text-red-800 dark:bg-red-900/30 dark:text-red-400" },
  { value: "WARM", label: "Warm", color: "bg-orange-100 text-orange-800 dark:bg-orange-900/30 dark:text-orange-400" },
  { value: "COLD", label: "Cold", color: "bg-gray-100 text-gray-800 dark:bg-gray-700 dark:text-gray-400" },
